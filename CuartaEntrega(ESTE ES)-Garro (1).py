...
# ##### 1: IMPORTAMOS LIBRERIAS Y PAQUETES NECESARIAS
...
# ##### 2. IMPORTAMOS LA BASE DE DATOS QUE SE ENCUENTRA EN UN ARCHIVO EXCEL
...
# ##### 3. VERFICAMOS SI SE REALIZÓ LA CARGA A PARTIR DE M0STRAR LOS PRIMEROS CINCO DATOS
...
# ##### 4. INSPECCIONAMOS EL DATASET PARA COMPRENDER LOS DATOS QUE TENEMOS
...
# ##### 5. CAMBIAMOS EL FORMATO DE LA COLUMNA FECHA A 'DATETIME' 
...
# ##### 6. VISUALIZACIÓN DE LOS OUTLIERS Y REMOCIÓN
...
# ##### 7. VISUALIZACIÓN DE LA VARIACIÓN DE CANT DE CASOS EN EL TIEMPO
...
# ##### 8. REALIZAMOS UN HISTOGRAMA EN EL QUE PODAMOS ANALIZAR LA DISTRIBUCIÓN DE LAS EDADES EN CADA PROVINCIA
# 
...
# ##### 9. GRÁFICAMOS CANTIDAD DE CASOS POR PROVINCIA:
...
# ##### 10. REALIZAMOS UNA ESTADICTICA DE EDADES POR PROVINCIA
...
# ##### 11. ANALIZAMOS EL VINCULO DEL AGRESOR CON LA VICTIMA
